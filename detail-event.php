    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 info-panel">
                <h1 class="gundaroomteam">DETAIL EVENT</h1>
            </div>
        </div>
        ...
        ?>
        <!-- Panel Detail Event -->
            <center><img class="detail-eventimg"src="<?php echo $event1['gambar']?>"></center>
            <h1 class="detail-eventtext"><?php echo $event1['judul'];?></h1>
            <div class="detail-kotak">
                <p class="detail-eventdeskripsi"><?php echo $event1['deskripsi'];?></p>
            </div>
        <!-- End Panel Detail Event -->
    </div>
