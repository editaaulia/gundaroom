  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <?php 
            ...
            if($proses=="hapus"){
                $memberid=mysqli_real_escape_string($kon,$_GET['member_id']);
            
                $hapus=mysqli_query($kon,"DELETE FROM member WHERE member_id='$memberid'");
                if($hapus){
    ...
    <div class="container">
        ...
        <table class="table table-bordered tabel-user">
            ...
            <tbody>
                <?php
                $i=1;
                    $tampil=mysqli_query($kon,"SELECT * FROM member");
                ...
                <tr>
                    ...
                    <td><a href="data-user.php?member_id=<?php echo $cetak['member_id']; ?>&&proses=hapus" class="btn btn-danger">Delete User</a></td>
                </tr>
                <?php $i=$i+1; }?>
            </tbody>
        </table>
