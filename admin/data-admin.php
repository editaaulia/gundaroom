  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <?php 
            ...
            if($proses=="hapus"){
                $idadmin=mysqli_real_escape_string($kon,$_GET['admin_id']);
            
                $hapus=mysqli_query($kon,"DELETE FROM admin WHERE admin_id='$idadmin'");
                if($hapus){
    ...
    <div class="container">
        ...
        <!-- Tombol Tambah -->
            <a class="btn btn-primary tombol-admin" href="add-admin.php">Tambah Admin</a>
        <!-- End Tombol Tambah -->
        ...
        <table class="table table-bordered tabel-admin">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="data-admin.php?admin_id=<?php echo $cetak['admin_id']; ?>&&proses=hapus" class="btn btn-danger">Delete Admin</a></td>
                </tr>
                <?php $i=$i+1; }?>
            </tbody>
	    </table>
